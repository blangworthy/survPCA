...
#'@param BivHaz A matrix with estimates of bivariate cause specific hazard function. Times for variable 1 are along the rows, times for variable 2 along columns.
#'@param BivSurv A matrix with estimates of bivariate survival times. Times for variable 1 are along the rows, times for variable 2 along columns.
#'@return A list with the following elements:
#'\itemize{
#'\item{BivIF: Jumps in the bivariate cause specific cumulative incidence function estimate}
